...
const SalesByCustomerTable = () => {
  ...
  const colorSchemes = [
    ...
    { name: 'yellow', label: 'Yellow', primary: '#FFCC33', secondary: '#FFFDE7', light: '#FFFDE7', isDark: false },
    { name: 'orange', label: 'Orange', primary: '#FF9800', secondary: '#FFE0B2', light: '#FFE0B2', isDark: false },
